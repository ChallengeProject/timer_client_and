        ...
        intent?.run {
            ...
            when (action) {
                CMD_PROC_SERVICE.START_WITH_TIMERS -> {
                    ...
                    "CMD_PROC_SERVICE.START_WITH_TIMERS times : ${timeSet.times.asSequence().map { it.seconds }.toList()}.to".e()
...
//                        stopSelf()
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                "sendBroadcast     millisUntilFinished $millisUntilFinished     time $time".e(TAG)
